...
public class Monitor {
    ...
    @CollectionTable(name = "monitor_tags", joinColumns = @JoinColumn(name = "monitor_id"))
    ...
    public Monitor(String name, String url, Integer intervalSeconds, String environment, Set<String> tags) {
        this.name = name;
        this.url = url;
